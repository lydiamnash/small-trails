...
class TrailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trail" do
    assert_difference('Trail.count') do
      post trails_url, params: { trail: { description: @trail.description, name: @trail.name } }
    end
  ...
  test "should update trail" do
    patch trail_url(@trail), params: { trail: { description: @trail.description, name: @trail.name } }
